/**
 * PudimMod — tradução de chat desenhado como lista.
 *
 ...
 * gui/session/chat/pudim_chat_tr.js.)
 *
 * A tradução em si vem da ponte em gui/common/pudim_translate.js.
 *
 * O dicionário do mod (pudim_T) não existe nestas telas — ele mora em
 * gui/session/, que nenhuma delas carrega. Por isso os textos daqui estão
 * escritos direto no arquivo.
 */
