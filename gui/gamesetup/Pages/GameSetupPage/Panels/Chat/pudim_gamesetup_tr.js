/**
 * PudimMod — liga a tradução do chat na tela de configuração da partida.
 *
 * É o chat onde se combina o jogo antes de começar, e na prática é onde mais
 * se conversa em multiplayer.
 *
 * Todo o comportamento está em gui/common/pudim_tr_lista.js, compartilhado com
...
pudim_patchApplyN(ChatMessagesPanel.prototype, "addText", function(alvo, esse, argumentos)
{
	...
	try {
		...
		warn("PudimMod: falha ao preparar a tradução do chat da configuração: " + e);
	}

	return resultado;
});

pudim_patchApplyN(ChatMessagesPanel.prototype, "clearChatMessages", function(alvo, esse, argumentos)
{
	pudim_TrListaLimpar();
